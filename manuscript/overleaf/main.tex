...
Several pairwise meta-analyses have compared etomidate and ketamine for emergency intubation,\cite{kotani2023,koroki2024,greer2025,daghmouri2025,demorais2025} consistently finding no difference in mortality. However, these analyses were limited to the etomidate--ketamine comparison and could not incorporate evidence from trials involving propofol or ketofol. The recent publication of two large trials---Casey et al.\cite{casey2025} (2,359 patients) and PROMINE\cite{schmidt2025}---has substantially expanded the available evidence.
