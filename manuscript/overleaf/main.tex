...
The 10 included trials\cite{jabre2009,cinar2011,punt2014,smischney2019,matchett2022,knack2023,srivilaithon2023,casey2025,agarwal2025,schmidt2025} enrolled 4,752 patients across four treatment nodes: etomidate (9 trials), ketamine (9 trials), propofol (1 trial), and ketofol (1 trial). Studies were conducted in ICU (5 trials), emergency department (3 trials), and mixed settings (2 trials), across seven countries. Sample sizes ranged from 22 to 2,359 patients. The characteristics of included studies are presented in Table~\ref{tab:characteristics}.

\subsection{Risk of bias}

Nine studies were rated as having ``some concerns'' and one (Punt 2014\cite{punt2014}) as ``high risk'' of bias (Figure~\ref{fig:rob}). The most common concerns were lack of blinding (only 1 of 10 studies was double-blind) and deviations from intended interventions. Mortality, as an objective outcome, was considered less susceptible to bias from lack of blinding.
...
\textbf{(B)} Summary plot showing the distribution of risk-of-bias judgements across all studies. Nine studies were rated as ``some concerns'' and one (Punt 2014) as ``high risk,'' driven by the cluster-randomized design and midazolam adjunct in the ketamine arm.}
\label{fig:rob}
\end{figure}
\end{landscape}
