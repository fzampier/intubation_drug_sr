...
\textbf{Background:}
Etomidate and ketamine are the most commonly used induction agents for emergency tracheal intubation in critically ill adults, yet existing meta-analyses are limited to pairwise comparisons of these two drugs. Despite widespread use in clinical practice, propofol has virtually no randomized evidence in this setting.
...
In this systematic review and network meta-analysis of 10 randomized trials enrolling 4,752 critically ill adults, we found that etomidate and ketamine probably result in similar short-term mortality (moderate certainty). Ketamine was associated with greater peri-intubation cardiovascular instability than etomidate. Evidence for propofol and ketofol was extremely limited, with comparisons involving these agents supported by single small trials or indirect evidence alone.
...
Ketamine was associated with higher odds of cardiovascular collapse, post-induction hypotension, and peri-intubation vasopressor use compared with etomidate. This may seem paradoxical given ketamine's sympathomimetic properties, but critically ill patients are often catecholamine-depleted, blunting the indirect sympathetic stimulation on which ketamine's hemodynamic stability depends. In this setting, ketamine's direct myocardial depressant effect may predominate. The protocol specified vasopressor analysis at up to 30 minutes, 1 hour, and 24 hours; at the 24-hour time point, substantial heterogeneity ($I^2$ = 93\%) precluded reliable estimation, highlighting the lack of standardized hemodynamic outcome definitions in this field.

The RSI trial\cite{casey2025} warrants detailed consideration. It enrolled 2,359 patients---nearly half of all patients in this review---across 14 sites in the United States, and was the first trial in this field adequately powered for a mortality endpoint (28-day mortality 22.2\% ketamine vs 21.5\% etomidate). Its pragmatic, multicenter design, use of exception from informed consent, and enrollment from both emergency departments and ICUs enhance generalizability to routine clinical practice. The RSI trial also provided the most granular hemodynamic data: cardiovascular collapse occurred in 25.1\% of ketamine vs 17.4\% of etomidate patients, largely driven by vasopressor escalation. These patterns are consistent with, and largely drive, the pooled estimates in our network meta-analysis.

PROMINE\cite{schmidt2025} fills a different and equally important gap as the only randomized trial comparing propofol with any other agent for emergency intubation in critically ill adults. It enrolled a higher-acuity ICU population in Brazil (hospital mortality 50\% in the propofol arm and 60\% in the esketamine arm) and used esketamine (the S-enantiomer) rather than racemic ketamine, though both are grouped under the ketamine node given their similar pharmacodynamic profile at induction doses. PROMINE is the sole reason propofol enters the treatment network, without which all propofol comparisons would be entirely absent from the evidence base. The etomidate--propofol comparison, which relies entirely on indirect evidence through the ketamine node, was accordingly rated as very low certainty. This represents a striking gap: the critical care community has debated etomidate versus ketamine for over 15 years while generating virtually no randomized evidence for the drug most anesthesiologists and intensivists use daily in other settings. The single ketofol trial (KEEP PACE\cite{smischney2019}) used reduced doses of both components with fentanyl co-administration, further limiting generalizability.
...
From a clinical perspective, etomidate and ketamine appear interchangeable with respect to mortality. The choice between them may reasonably be guided by the anticipated hemodynamic trajectory: for patients at immediate risk of peri-intubation cardiovascular collapse, etomidate's hemodynamic stability offers a short-term advantage. The near-complete absence of randomized evidence for propofol in emergency intubation is a critical gap that future trials should address directly. Equally important is the adoption of standardized hemodynamic outcome definitions---particularly for vasopressor use---to enable meaningful comparison across future studies.
