...
\textbf{Conclusions:}
Whether etomidate or ketamine is safer remains uncertain---confidence intervals are compatible with clinically important mortality differences in either direction---ketamine causes more peri-intubation hemodynamic instability. Beyond one trial, no randomized evidence exists for propofol in emergency intubation of critically ill adults.
...
\quad Vasopressor, 24 hours$^{a}$    & 2 [2] (2,421) & PW  & 0.58 (0.14--2.33) & 96\% & Very low \\
