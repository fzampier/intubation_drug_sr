...
\vspace{1.5cm}
{\large
Fernando G.\ Zampieri, MD, PhD$^{1,2,6}$;
Raysa C.\ Schmidt, MD$^{2,6}$;
Bruno A.M.P.\ Besen, MD, PhD$^{2,3,6}$;
Fernando J.D.S.\ Ramos, MD, PhD$^{2,6}$;
Fran\c{c}ois Lamontagne, MD, MSc$^{4}$;
Neill K.J.\ Adhikari, MDCM, MSc$^{5}$;
Fl\'avio G.R.\ Freitas, MD, PhD$^{2,6}$;
Fl\'avia R.\ Machado, MD, PhD$^{2,6}$\\[0.3cm]
...
$^{6}$ Brazilian Research in Intensive Care Network (BRICNet)\\
\vspace{1cm}
...
\vspace{1cm}
\textbf{Word count:} Abstract: 250 / Manuscript: 2,531\\
...
\textbf{Results:}
Nine trials (4,672 patients, four treatments) were included. For the primary outcome, there was no difference between ketamine and etomidate (OR 0.96, 95\% CI 0.80--1.16; $I^2$ = 30\%; moderate certainty). Evidence for other mortality comparisons was sparse: ketamine vs propofol (OR 1.53, 0.80--2.93; 1 trial; low certainty) and etomidate vs propofol (OR 0.63, 0.32--1.24; indirect only; very low certainty). Compared with etomidate, ketamine was associated with higher odds of cardiovascular collapse (OR 1.44, 1.20--1.71; moderate certainty), post-induction hypotension (OR 1.34, 1.07--1.68; low certainty), and peri-intubation vasopressor use (OR 1.45, 1.21--1.74; low certainty). No differences were observed for first-pass intubation success or cardiac arrest.
...
Sensitivity analyses excluded: (a) studies where the ketamine arm included a midazolam adjunct (Cinar 2011,\cite{cinar2011} Punt 2014\cite{punt2014}); (b) high risk-of-bias studies (Punt 2014\cite{punt2014}); (c) small studies ($<$30 patients per arm); and (d) analyses collapsing or removing ketofol as a separate treatment node.
...
The search identified 1,087 records after deduplication. After title/abstract screening and full-text review, 9 trials met the inclusion criteria (Figure~\ref{fig:prisma}). One additional trial (Agarwal 2025\cite{agarwal2025}) initially met the eligibility criteria but was excluded after independent review identified that its published summary statistics---including means, standard deviations, medians, and interquartile ranges across all baseline variables---were identical to those of Srivilaithon 2023,\cite{srivilaithon2023} a previously included study conducted in a different country with a different sample size, consistent with data fabrication.
...
Eight studies were rated as having ``some concerns'' and one (Punt 2014\cite{punt2014}) as ``high risk'' of bias (Figure~\ref{fig:rob}). The most common concerns were lack of blinding (only 1 of 9 studies was double-blind) and deviations from intended interventions. Mortality, as an objective outcome, was considered less susceptible to bias from lack of blinding.
...
In this systematic review and network meta-analysis of 9 randomized trials enrolling 4,672 critically ill adults, etomidate and ketamine had similar short-term mortality but confidence intervals do not exclude clinically important differences. Ketamine caused more peri-intubation cardiovascular instability than etomidate. Evidence for propofol and ketofol was limited to single trials.
...
Etomidate and ketamine result in similar short-term mortality, but confidence intervals do not exclude clinically important differences in either direction, and ketamine is associated with more peri-intubation hemodynamic instability. Evidence for propofol is limited to a single trial. Large uncertainty remains regarding the optimal drug for emergency intubation of critically ill patients. Further trials---particularly testing propofol against etomidate and ketamine---are needed.
...
\textit{Intensive Care Med}. 2025 (accepted).
...
\quad Post-induction hypotension     & 4 (2,871) & NMA & 1.34 (1.07--1.68) & 0\% & Low \\
\quad Vasopressor, peri-intubation   & 5 (3,413) & NMA & 1.45 (1.21--1.74) & 0\% & Low \\
\quad Vasopressor, 24 hours$^{a}$    & 2 (2,421) & PW  & 0.58 (0.14--2.33) & 96\% & Very low \\
\quad First-pass intubation success  & 5 (3,718) & NMA & 0.95 (0.77--1.16) & 0\% & Moderate \\
\quad Peri-intubation cardiac arrest & 7 (4,142) & NMA & 1.13 (0.70--1.82) & 0\% & Low \\
\bottomrule
\end{tabularx}
\vspace{4pt}
\raggedright\footnotesize
...
$^{a}$Substantial heterogeneity; individual study ORs were 0.87 (Casey 2025) and 0.28 (Srivilaithon 2023). Result should be interpreted with caution.\\
$^{b}$Secondary outcomes for propofol comparisons are available in the Supplement (eFigures).
\end{table}
\end{landscape}
