...
\textbf{Background:}
Etomidate, ketamine, and propofol are all used as induction agents for emergency tracheal intubation in critically ill adults, yet existing meta-analyses are limited to pairwise comparisons of etomidate and ketamine. Propofol has virtually no randomized evidence in this setting despite its widespread use.
...
\textbf{Conclusions:}
Whether etomidate or ketamine is safer remains uncertain---confidence intervals are compatible with clinically important mortality differences in either direction---and ketamine causes more peri-intubation hemodynamic instability. Beyond one small trial, no randomized evidence exists for propofol in emergency intubation of critically ill adults. Larger trials---particularly of propofol---are needed.
...
The RSI trial\cite{casey2025} enrolled 2,359 patients---nearly half of all patients in this review---across 14 sites in the United States and was the first trial powered for a mortality endpoint (28-day mortality 22.2\% ketamine vs 21.5\% etomidate). It also provided the most detailed hemodynamic data: cardiovascular collapse occurred in 25.1\% of ketamine vs 17.4\% of etomidate patients, largely driven by vasopressor escalation. These patterns are consistent with, and largely drive, the pooled estimates in our network meta-analysis.

PROMINE\cite{schmidt2025} is the only randomized trial comparing propofol with any other induction agent for emergency intubation in critically ill adults. It enrolled 175 ICU patients in Brazil, comparing esketamine with propofol, and reported higher hospital mortality with esketamine (60\% vs 50\%, OR 1.53, 95\% CI 0.80--2.92). Because PROMINE is the sole trial connecting propofol to the network, all propofol comparisons depend on it. The indirect estimate for etomidate versus propofol (OR 0.63, 95\% CI 0.32--1.24; very low certainty) suggests propofol might reduce mortality compared with etomidate, but this estimate passes through the ketamine node and rests on a single small trial---it should not be taken at face value. Similarly, the direct ketamine--propofol comparison from PROMINE alone is too imprecise to draw conclusions: the confidence interval is compatible with propofol reducing mortality by 20\% or increasing it nearly threefold. What these estimates do show is that propofol is not obviously worse than etomidate or ketamine for mortality, which should motivate larger trials. No trial has directly compared propofol with etomidate. The single ketofol trial (KEEP PACE\cite{smischney2019}) used reduced doses of both components with fentanyl co-administration, limiting its generalizability.
...
Taken together, the evidence base for induction agent selection in emergency intubation is thin. The RSI trial accounts for nearly half of all randomized patients and is the only trial powered for mortality. The remaining eight etomidate--ketamine trials are small and none was designed to detect a mortality difference. PROMINE is the first and only trial to randomize propofol against any comparator in this setting, but with 175 patients it can only be considered hypothesis-generating. No trial has compared propofol with etomidate. Whether etomidate or ketamine leads to lower mortality remains uncertain, with confidence intervals compatible with clinically important differences in either direction; etomidate does cause less short-term hemodynamic instability. Beyond the etomidate--ketamine comparison, the field needs large trials testing propofol---the most widely used induction agent in elective practice---in emergency intubation. Standardized definitions for hemodynamic outcomes, particularly vasopressor use, are also needed to allow meaningful comparison across future studies.
...
Whether etomidate or ketamine is safer remains uncertain---confidence intervals are compatible with clinically important mortality differences in either direction---and ketamine causes more peri-intubation hemodynamic instability. Beyond this comparison, the evidence is sparse. Only one small trial has tested propofol against any comparator for emergency intubation in critically ill adults, and no trial has compared propofol with etomidate. Large trials of propofol in this setting are the most important next step.
