...
\caption*{\textbf{eFigure~\theefigure.} Sensitivity analysis excluding Casey 2025 (RSI trial): vasopressor use at 24 hours (etomidate vs ketamine direction). One study remaining (Srivilaithon 2023). OR 3.63 (2.06--6.41), indicating substantially higher 24-hour vasopressor use with etomidate in this sepsis-only population. Heterogeneity present in the main analysis ($I^2$ = 93\%) cannot be assessed with a single study.}
\end{efigure}
...
Lowest MAP 10 min, median (IQR) & 60 (48--72) & 66 (55--79) & adj.\ MD 6.0 ($-$0.0 to 11.9) \\
