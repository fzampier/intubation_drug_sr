...
\caption*{\textbf{eFigure~\theefigure.} Sensitivity analysis excluding Casey 2025 (RSI trial): post-induction hypotension. Four studies remaining (Knack, Srivilaithon, Agarwal, Schmidt). Ketamine vs etomidate OR 0.98 (0.59--1.62); finding attenuated and no longer significant.}
\end{efigure}
...
\caption*{\textbf{eFigure~\theefigure.} Sensitivity analysis excluding Casey 2025 (RSI trial): vasopressor use at 24 hours. Two studies remaining (Srivilaithon, Agarwal). Pairwise OR 3.68 (2.24--6.06), $I^2$ = 0\%. Heterogeneity present in the main analysis ($I^2$ = 93\%) resolved, suggesting Casey was the source of heterogeneity for this outcome.}
\end{efigure}

\begin{efigure}[p]
\centering
\includegraphics[width=0.85\textwidth]{eFigure21_sens_excl_casey_cardiac_arrest.pdf}
\caption*{\textbf{eFigure~\theefigure.} Sensitivity analysis excluding Casey 2025 (RSI trial): peri-intubation cardiac arrest. Seven studies remaining. Ketamine vs etomidate OR 1.08 (0.61--1.92); finding unchanged.}
\end{efigure}
