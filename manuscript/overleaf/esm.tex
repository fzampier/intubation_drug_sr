...
{\normalsize Zampieri FG, Schmidt RC, Besen BAMP, Ramos FJDS, Freitas FGR, Machado FR}\\[4pt]
...
\caption*{\textbf{eFigure~\theefigure.} Forest plot for vasopressor use, peri-intubation (induction to 2--5 minutes). Four studies contributed.}
\end{efigure}
...
% --- eFigure 8: Vasopressor extended ---
\begin{efigure}[p]
\centering
\includegraphics[width=0.85\textwidth]{eFigure8_forest_vaso_extended.pdf}
\caption*{\textbf{eFigure~\theefigure.} Forest plot for vasopressor use, extended timeframe (ICU stay or Days 1--4). Three studies contributed. The direction reversal compared with peri-intubation vasopressor use (ketamine now favored) may reflect etomidate-induced adrenal suppression.}
\end{efigure}

% --- eFigure 9: Funnel plot ---
\begin{efigure}[p]
\centering
\includegraphics[width=0.75\textwidth]{eFigure9_funnel_mortality.pdf}
...
% --- eFigure 10: Subgroup by setting ---
\begin{efigure}[p]
\centering
\includegraphics[width=0.9\textwidth]{eFigure10_subgroup_setting.pdf}
...
% --- eFigure 11: Subgroup by RoB ---
\begin{efigure}[p]
\centering
\includegraphics[width=0.9\textwidth]{eFigure11_subgroup_rob.pdf}
...
% --- eFigure 12: ICU subgroup NMA ---
\begin{efigure}[p]
\centering
\includegraphics[width=0.85\textwidth]{eFigure12_subgroup_ICU_nma.pdf}
...
% --- eFigure 13--17: Sensitivity analyses ---
\begin{efigure}[p]
\centering
\includegraphics[width=0.85\textwidth]{eFigure13_sens_no_midaz.pdf}
...
\begin{efigure}[p]
\centering
\includegraphics[width=0.85\textwidth]{eFigure14_sens_no_high_rob.pdf}
...
\begin{efigure}[p]
\centering
\includegraphics[width=0.85\textwidth]{eFigure15_sens_no_small.pdf}
...
\begin{efigure}[p]
\centering
\includegraphics[width=0.85\textwidth]{eFigure16_sens_collapse_ketofol.pdf}
...
\begin{efigure}[p]
\centering
\includegraphics[width=0.85\textwidth]{eFigure17_sens_remove_ketofol.pdf}
...
Vaso (ext.) & SC & SC & SC & SC & NC & NC & Low \\
...
SC = some concerns; NC = no concerns. Vaso = vasopressor use; peri = peri-intubation; ext.\ = extended. CV = cardiovascular. See main text for detailed rationale.
\end{etabletab}
