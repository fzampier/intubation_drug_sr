...
\caption*{\textbf{eFigure~\theefigure.} Forest plot for vasopressor use at 24 hours. Two studies contributed. Substantial heterogeneity ($I^2$ = 96\%) precludes reliable pooled estimation. Individual study ORs ranged from 1.15 (Casey 2025) to 3.63 (Srivilaithon 2023).}
\end{efigure}
...
\caption*{\textbf{eFigure~\theefigure.} Sensitivity analysis excluding Casey 2025 (RSI trial): vasopressor use at 24 hours. One study remaining (Srivilaithon 2023). OR 3.63 (2.06--6.41). Heterogeneity present in the main analysis ($I^2$ = 96\%) cannot be assessed with a single study.}
\end{efigure}
...
\midrule
Within-study bias & Some concerns & All 7 contributing studies rated ``some concerns'' (6) or ``high risk'' (1, Punt). Dominant concern: open-label designs in 4/7 studies. Mortality is objective, mitigating unblinding concern. \\
...
Imprecision & Some concerns & 95\% CI (0.80--1.16) includes OR = 1.0 but excludes large effects ($>$16\% relative). Total N = 4,345. \\
