# GRADE / CINeMA Assessment — Certainty of Evidence
...
**Overall certainty: LOW** (downgraded one level for imprecision [major], one level for indirectness)

**Interpretation:** Low certainty evidence. The point estimate suggests potentially higher mortality with esketamine vs propofol, but the confidence interval is very wide and includes no difference. This comparison rests on a single moderate-sized trial in high-acuity Brazilian ICU patients.

---

### 3. Etomidate vs Propofol — OR 0.63 (0.32–1.24)
...
**Interpretation:** Very low certainty evidence. The indirect estimate suggests potentially lower mortality with propofol compared to etomidate, but this is highly uncertain. No direct comparison exists, and the indirect pathway relies on a single connecting study (PROMINE) with important differences from the etomidate-ketamine evidence base.
...
|---|---|---|
| Within-study bias | Some concerns | 2 direct studies (Matchett, Casey), both "some concerns" (open-label). Casey contributes ~60% of weight. |
| Reporting bias | Some concerns | Only 3 studies total in NMA. Definition varies slightly between studies. |
| Indirectness | No concerns | Both studies use similar composite definitions. Directly applicable to target population. |
| Imprecision | No concerns | Statistically significant with narrow CI. N = 2,760 for direct comparison. |
| Heterogeneity | No concerns | I² = 0%, tau² = 0. |
| Incoherence | No concerns | Consistent between direct studies. |

**Overall certainty: MODERATE** (downgraded once for within-study bias)

**Interpretation:** Moderate certainty that ketamine increases cardiovascular collapse risk compared to etomidate (approximately 44% higher odds), driven by peri-intubation vasopressor escalation.
...
| Domain | Judgement | Rationale |
|---|---|---|
| Within-study bias | Some concerns | 4 direct studies, all "some concerns." Casey contributes dominant weight. |
| Reporting bias | Some concerns | Hypotension definitions vary across studies (SBP<80, SBP<90, MAP<65). |
| Indirectness | Some concerns | Heterogeneous outcome definitions across studies. Different time windows (peri-intubation vs ED stay vs within 1 hour). |
| Imprecision | No concerns | Statistically significant. |
| Heterogeneity | No concerns | I² = 0%. |
| Incoherence | No concerns | Consistent direction across studies. |
...
| Domain | Judgement | Rationale |
|---|---|---|
| Within-study bias | Some concerns | Casey dominates (~90% weight), "some concerns." |
| Reporting bias | Some concerns | Limited studies. |
| Indirectness | Some concerns | Definitions and timeframes vary (2 min vs 5 min vs "during intubation"). |
| Imprecision | No concerns | Significant result with reasonably narrow CI. |
| Heterogeneity | No concerns | I² = 0%. |
...
*Absolute effects calculated assuming a baseline mortality risk of 30% (median across included studies).*
